...
uses
  ...
  ShellApi, tlhelp32, psAPI, Filectrl;
...
begin
  ...
  //Label4.Caption := 'Total system memory: ' +
  //  FormatFloat('###,###', MemStat.dwTotalPhys / 1024) + ' KByte';
  //Label18.Caption  := 'Free physical memory: ' +
  ...
  begin
    ...
    Label18.Caption := FormatFloat('###,###',
                       (NewWorkingMemory - OldWorkingMemory) / 1024) + ' KByte';
...
begin
  ...
  if CheckBox8.Checked = true then begin
      ...
      begin
        ...
        msgC := msgC;
        Label14.Caption := 'Memory Leak Count    : ' + msgC + ' Blocks';
      end else begin
      ...
      begin
        ...
        msgS := msgS;
        Label15.Caption := 'Memory Leak Size     : ' + msgS + ' Bytes';
      end else begin
